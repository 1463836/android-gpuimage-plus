 ...
 */
attribute_deprecated
int avcodec_encode_video(AVCodecContext * avctx, uint8_t * buf, int
buf_size,
const AVFrame *pict
);
#endif
...
void avcodec_set_dimensions(AVCodecContext * s, int
width,
int height
);
...
int avcodec_default_execute(AVCodecContext * c, int(*func)
(
AVCodecContext *c2,
void *arg2
),
...
int avcodec_default_execute2(AVCodecContext * c, int(*func)
(
AVCodecContext *c2,
void *arg2,
int, int),
 ...
 *                     determine.
 */
int av_get_audio_frame_duration(AVCodecContext * avctx, int
frame_bytes);
