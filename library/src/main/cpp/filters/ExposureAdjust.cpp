...
static ConstString s_fshExposure = CGE_SHADER_STRING_PRECISION_H
                                      (
                                              ...
                                              void main() {
                                                  vec4 color = texture2D(inputImageTexture,
                                                                         textureCoordinate);
                                                  gl_FragColor = vec4(color.rgb * exp2(exposure),
                                                                      color.a);
                                              });

namespace CGE {
    ConstString CGEExposureFilter::paramName = "exposure";
