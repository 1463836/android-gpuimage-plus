...
#include "MinValueFilter.h"

static ConstString s_minValueFunc = CGE_SHADER_STRING
(
...
static ConstString s_vshMinValue3x3 = CGE_SHADER_STRING
(
...
static ConstString s_vshMinValue3x3_2 = CGE_SHADER_STRING
(
...
static ConstString s_fshMinValue3x3 = CGE_SHADER_STRING_PRECISION_M
                                         (
                                                 varying vec2 texCoord[9];
...
static ConstString s_fshMinValue3x3_2 = CGE_SHADER_STRING_PRECISION_M
                                           (
                                                   varying vec4 texCoord0;
                                                   varying vec4 texCoord1;
                                                   varying vec4 texCoord2;
...
namespace CGE {
    ConstString CGEMinValueFilter3x3::paramSamplerStepsName = "samplerSteps";
    ...
    void CGEMinValueFilter3x3::render2Texture(ImageHandlerInterface *handler, GLuint srcTexture,
...
static ConstString s_vshMinValue3x3Plus = CGE_SHADER_STRING
(
...
static ConstString s_vshMinValue3x3Plus_2 = CGE_SHADER_STRING
(
        varying vec4 texCoord0;
        varying vec4 texCoord1;
        varying vec4 texCoord2;
...
static ConstString s_fshMinValue3x3Plus = CGE_SHADER_STRING_PRECISION_M
                                             (
                                                     varying vec2 texCoord[13];
...
static ConstString s_fshMinValue3x3Plus_2 = CGE_SHADER_STRING_PRECISION_M
                                               (
                                                       varying vec4 texCoord0;
                                                       varying vec4 texCoord1;
                                                       varying vec4 texCoord2;
