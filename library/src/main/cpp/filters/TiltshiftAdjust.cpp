...
static ConstString s_fshTiltshiftVector = CGE_SHADER_STRING_PRECISION_M
(
...
static ConstString s_fshTiltshiftEllipse = CGE_SHADER_STRING_PRECISION_H
(
        varying vec2 textureCoordinate;
        uniform sampler2D inputImageTexture;
        uniform sampler2D blurredImageTexture;
...
static ConstString paramBlurredTexName = "blurredImageTexture";
static ConstString paramStepsName = "vSteps";

namespace CGE {
    ConstString CGETiltshiftVectorFilter::paramGradientName = "blurGradient";
    ConstString CGETiltshiftVectorFilter::paramBlurPassPosName = "blurPassPos";
    ConstString CGETiltshiftVectorFilter::paramBlurNormalName = "blurNormal";
    ...
    void
    CGETiltshiftVectorFilter::render2Texture(ImageHandlerInterface *handler, GLuint srcTexture,
    ...
    ConstString CGETiltshiftEllipseFilter::paramRotationName = "mRot";
    ConstString CGETiltshiftEllipseFilter::paramGradientName = "blurGradient";
    ConstString CGETiltshiftEllipseFilter::paramCentralPosName = "blurCentralPos";
    ConstString CGETiltshiftEllipseFilter::paramRadiusStartName = "radiusStart";
    ...
    void CGETiltshiftEllipseFilter::setRotation(GLfloat rot) {
        m_program.bind();
        GLint loc = glGetUniformLocation(m_program.getProgramID(), paramRotationName);
        GLfloat mat[4];
        mat[0] = cosf(rot);
        mat[1] = -sinf(rot);
        mat[2] = -mat[1];
    ...
    void
    CGETiltshiftEllipseFilter::render2Texture(ImageHandlerInterface *handler, GLuint srcTexture,
                                              GLuint vertexBufferID) {
        handler->setAsTarget();
        m_program.bind();
        const Sizei &sz = handler->getOutputFBOSize();
