...
static ConstString s_vshMidValue3x3 = CGE_SHADER_STRING
(
...
static ConstString s_fshMidValue3x3 = CGE_SHADER_STRING_PRECISION_M
                                         (
                                                 varying vec2 texCoord[9];
                                                 ...
                                                 vec3 max2(vec3 c0, vec3 c1) {
                                                     return mix(newValue, originValue,
                                                                step(lum(newValue),
                                                                     lum(originValue)));
                                                 }
                                                 ...
                                                 void main() {
                                                     ...
                                                     for (int i = 0; i < 3; ++i) {
                                                         vec3 a = texture2D(inputImageTexture,
                                                                            texCoord[i * 3]);
                                                         vec3 b = texture2D(inputImageTexture,
                                                                            texCoord[i * 3 + 1]);
                                                         vec3 c = texture2D(inputImageTexture,
                                                                            texCoord[i * 3 + 2]);
                                                     ...
                                                     maxGroup[0] = min3(maxGroup[0], maxGroup[1],
                                                                        maxGroup[2]);
                                                     midGroup[0] = mid3(midGroup[0], midGroup[1],
                                                                        midGroup[2]);
                                                     minGroup[0] = min3(minGroup[0], minGroup[1],
                                                                        minGroup[2]);

                                                     vec3 result = mid3(maxGroup[0], midGroup[0],
                                                                        minGroup[0]);
