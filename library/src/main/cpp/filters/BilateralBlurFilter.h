...
namespace CGE {
    ...
    protected:
        static ConstString paramDistanceFactorName;
        static ConstString paramBlurSamplerScaleName;
        static ConstString paramBlurFactorsName;
    };
    ...
    protected:
        static ConstString paramBlurRadiusName;
        int m_limit;
    };

    //特殊用法
    class CGEBilateralWrapperFilter : public ImageFilterInterface {
    public:
