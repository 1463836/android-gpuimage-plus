...
namespace CGE {
    class CGETiltshiftVectorFilter : public ImageFilterInterface {
    public:
    ...
    protected:
        ...
        static ConstString paramGradientName;
        static ConstString paramBlurPassPosName;
    ...
    class CGETiltshiftEllipseFilter : public ImageFilterInterface {
    public:
    ...
    protected:
        GLuint m_texture;
        CGEBlurFastFilter m_blurProc;
        static ConstString paramRotationName;
        static ConstString paramGradientName;
        static ConstString paramCentralPosName;
        static ConstString paramRadiusStartName;
