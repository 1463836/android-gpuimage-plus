...
static ConstString s_blendHelpStart = CGE_SHADER_STRING_PRECISION_H
                                         (
...
static ConstString s_blendKeepRatioHelpStart = CGE_SHADER_STRING_PRECISION_H
                                                  (
                                                          varying vec2 textureCoordinate;
                                                          uniform sampler2D inputImageTexture;
                                                          uniform sampler2D blendTexture;
...
static ConstString s_blendTileHelpStart = CGE_SHADER_STRING_PRECISION_H
                                             (
                                                     varying vec2 textureCoordinate;
                                                     uniform sampler2D inputImageTexture;
                                                     uniform sampler2D blendTexture;
...
static ConstString s_blendPixelHelpStart = CGE_SHADER_STRING_PRECISION_H
                                              (
                                                      varying vec2 textureCoordinate;
                                                      uniform sampler2D inputImageTexture;
...
static ConstString s_blendWithSelfHelpStart = CGE_SHADER_STRING_PRECISION_H
                                                 (
                                                         varying vec2 textureCoordinate;
                                                         uniform sampler2D inputImageTexture;
                                                         uniform float intensity;
...
static ConstString s_blendVignetteHelpStart = CGE_SHADER_STRING_PRECISION_H
                                                 (
                                                         varying vec2 textureCoordinate;
                                                         uniform sampler2D inputImageTexture;
                                                         uniform vec4 blendColor;
...
static ConstString s_blendVignette2HelpStart = CGE_SHADER_STRING_PRECISION_H
                                                  (
                                                          varying vec2 textureCoordinate;
                                                          uniform sampler2D inputImageTexture;
                                                          uniform vec4 blendColor;
...
static ConstString s_blendVignetteNoAlphaHelpStart = CGE_SHADER_STRING_PRECISION_H
                                                        (
                                                                varying vec2 textureCoordinate;
                                                                uniform sampler2D inputImageTexture;
                                                                uniform vec4 blendColor;
...
static ConstString s_blendVignette2NoAlphaHelpStart = CGE_SHADER_STRING_PRECISION_H
                                                         (
                                                                 varying vec2 textureCoordinate;
                                                                 uniform sampler2D inputImageTexture;
                                                                 uniform vec4 blendColor;
...
static ConstString s_hardLight = CGE_SHADER_STRING
(
...
static ConstString s_overLay = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
            if (src1.r < 0.5)
                src2.r = (src1.r * src2.r) * 2.0;
...
static ConstString s_softLight = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
            if (src2.r < 0.5)
...
static ConstString s_screen = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_linearLight = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_vividLight = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
            src2.r =
                    src2.r < 0.5 ? 1.0 - (1.0 - src1.r) / (src2.r * 2.0) : src1.r / (1.0 - src2.r) *
                                                                           0.5;
            src2.g =
                    src2.g < 0.5 ? 1.0 - (1.0 - src1.g) / (src2.g * 2.0) : src1.g / (1.0 - src2.g) *
                                                                           0.5;
            src2.b =
                    src2.b < 0.5 ? 1.0 - (1.0 - src1.b) / (src2.b * 2.0) : src1.b / (1.0 - src2.b) *
                                                                           0.5;
...
static ConstString s_multiply = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_exclude = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_darken = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_lighten = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_colorBurn = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_colorDodge = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_linearDodge = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_linearBurn = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_pinLight = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
            src2 *= 2.0;
            if (src2.r > src1.r) {
...
static ConstString s_hardMix = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_difference = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_add = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_mix = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
            return mix(src1, src2, alpha);
        }
...
static ConstString s_color = CGE_SHADER_STRING
(
...
static ConstString s_addReverse = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_colorBW = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_dissolve = CGE_SHADER_STRING
(
...
static ConstString s_darkerColor = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
            vec3 dst = dot(src1, vec3(0.299, 0.587, 0.114)) < dot(src2, vec3(0.299, 0.587, 0.114))
                       ? src1 : src2;
            return mix(src1, dst, alpha);
        }
);

static ConstString s_lighterColor = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
            vec3 dst = dot(src1, vec3(0.299, 0.587, 0.114)) > dot(src2, vec3(0.299, 0.587, 0.114))
                       ? src1 : src2;
...
static ConstString s_subtract = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
...
static ConstString s_divide = CGE_SHADER_STRING
(
        vec3 blend(vec3 src1, vec3 src2, float alpha) {
            return mix(src1, min(src1 / src2, 1.0), alpha);
        }
...
static ConstString s_hue = CGE_SHADER_STRING
(
...
static ConstString s_saturation = CGE_SHADER_STRING
(
        vec3 RGB2HSL(vec3 src) {
            float maxc = max(max(src.r, src.g), src.b);
            float minc = min(min(src.r, src.g), src.b);
...
static ConstString s_luminosity = CGE_SHADER_STRING
(
        float getLumValue(vec3 src) {
            return 0.299 * src.r + 0.587 * src.g + 0.114 * src.b;
        }
...
namespace CGE {
    ConstString CGEBlendInterface::paramIntensityName = "intensity";
    ...
    bool CGEBlendFilter::initWithMode(CGETextureBlendMode mode) {
        ...
        loge("Init CGEBlendFilter failed, Mode number %d\n", mode);
        return false;
    }
    ...
    ConstString CGEBlendFilter::paramBlendTextureName = "blendTexture";

    void CGEBlendWithResourceFilter::setTexSize(int w, int h) {
        m_blendTextureSize.set(w, h);
    }

    ConstString CGEBlendKeepRatioFilter::paramAspectRatioName = "ratioAspect";
    ...
    void CGEBlendKeepRatioFilter::flushTexSize() {
        if (!m_uniformParam)
            return;
        UniformParameters::UniformData *data = m_uniformParam->getDataPointerByName(
                paramAspectRatioName);
        data->uniformValue[0].valuef = m_blendTextureSize.width / (float) m_blendTextureSize.height;
    }

    ConstString CGEBlendTileFilter::paramScalingRatioName = "scalingRatio";
    ...
    bool CGEBlendTileFilter::initWithMode(CGETextureBlendMode mode) {
        ...
        loge("Init BlendProcessor failed, Mode number %d\n", mode);
        return false;
    }
    ...
    void CGEBlendTileFilter::render2Texture(ImageHandlerInterface *handler, GLuint srcTexture,
        ...
        const Sizei &sz = handler->getOutputFBOSize();
    ...
    ConstString CGEPixblendFilter::paramBlendColorName = "blendColor";
    ...
    bool CGEPixblendFilter::initWithMode(CGETextureBlendMode mode) {
        ...
        loge("Init CGEPixblendFilter failed, Mode number %d\n", mode);
        return false;
    }
    ...
    bool CGEBlendWithSelfFilter::initWithMode(CGETextureBlendMode mode) {
        ...
        loge("Init CGEBlendWithSelfFilter failed, Mode number %d\n", mode);
        return false;
    }
    ...
    ConstString CGEBlendVignetteFilter::paramVignetteCenterName = "vignetteCenter";
    ConstString CGEBlendVignetteFilter::paramVignetteName = "vignette";
