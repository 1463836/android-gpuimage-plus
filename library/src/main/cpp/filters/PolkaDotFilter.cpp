...
static ConstString s_fshPolkaDot = CGE_SHADER_STRING_PRECISION_M
                                      (
                                              ...
                                              void main() {
                                                  ...
                                                  float checkForPresenceWithinDot = step(dis,
                                                                                         (dotPercent.x *
                                                                                          0.5) *
                                                                                         dotScaling);
                                                  vec4 color = texture2D(inputImageTexture,
                                                                         samplePos);
                                                  gl_FragColor = vec4(
                                                          color.rgb * checkForPresenceWithinDot,
                                                          color.a);

                                              });

namespace CGE {
    ConstString CGEPolkaDotFilter::paramDotScaling = "dotScaling";
