...
ConstString s_fshCrosshatch = CGE_SHADER_STRING_PRECISION_H
                                 (
...
namespace CGE {
    ConstString CGECrosshatchFilter::paramCrosshatchSpacing = "crossHatchSpacing";
    ConstString CGECrosshatchFilter::paramLineWidth = "lineWidth";
