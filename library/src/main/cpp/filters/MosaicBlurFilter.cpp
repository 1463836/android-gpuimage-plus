...
static ConstString s_fshMosaic = CGE_SHADER_STRING_PRECISION_M
                                    (
                                            ...
                                            void main() {
                                                vec2 coord =
                                                        floor(textureCoordinate / samplerSteps /
                                                              blurPixels) * samplerSteps *
                                                        blurPixels;
...
namespace CGE {
    ConstString CGEMosaicBlurFilter::paramBlurPixelsName = "blurPixels";
