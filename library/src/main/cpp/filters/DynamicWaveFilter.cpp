...
static ConstString s_fshWave = CGE_SHADER_STRING_PRECISION_M
                                  (
                                          ...
                                          void main() {
                                              vec2 coord;
                                              coord.x = textureCoordinate.x + strength *
                                                                              sin(motion +
                                                                                  textureCoordinate.x *
                                                                                  angle);
                                              coord.y = textureCoordinate.y + strength *
                                                                              sin(motion +
                                                                                  textureCoordinate.y *
                                                                                  angle);
...
namespace CGE {
    ConstString CGEDynamicWaveFilter::paramMotion = "motion";
    ConstString CGEDynamicWaveFilter::paramAngle = "angle";
    ConstString CGEDynamicWaveFilter::paramStrength = "strength";
    ...
    void CGEDynamicWaveFilter::render2Texture(ImageHandlerInterface *handler, GLuint srcTexture,
