...
static ConstString s_fshVignette = CGE_SHADER_STRING_PRECISION_M
                                      (
                                              ...
                                              void main() {
                                                  ...
                                                  float d = distance(textureCoordinate,
                                                                     vignetteCenter);
                                                  float percent = clamp(
                                                          (d - vignette.x) / vignette.y, 0.0, 1.0);
...
static ConstString s_fshVignetteLinear = CGE_SHADER_STRING_PRECISION_M
                                            (
                                                    varying vec2 textureCoordinate;
                                                    uniform sampler2D inputImageTexture;
                                                    uniform vec2 vignette;
                                                    ...
                                                    void main() {
                                                        ...
                                                        gl_FragColor = vec4(
                                                                mix(vignetteColor, src.rgb, alpha),
                                                                src.a);
                                                    }
                                            );

namespace CGE {
    ConstString CGEVignetteFilter::paramVignetteCenterName = "vignetteCenter";
    ConstString CGEVignetteFilter::paramVignetteName = "vignette";
    ...
    ConstString CGEVignetteExtFilter::paramVignetteColor = "vignetteColor";
