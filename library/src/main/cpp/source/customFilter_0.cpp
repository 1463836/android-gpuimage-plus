                              ...
                              (
                                      ...
                                      vec3 hardLight(vec3 src1, vec3 src2, float alpha) {
                                          if (src2.r < 0.5)
                                              ...
                                              src2.r = (src1.r + src2.r) * 2.0 -
                                                       (src1.r * src2.r) * 2.0 - 1.0;

                                          if (src2.g < 0.5)
                                              src2.g = (src1.g * src2.g) * 2.0;
                                          else
                                              src2.g = (src1.g + src2.g) * 2.0 -
                                                       (src1.g * src2.g) * 2.0 - 1.0;

                                          if (src2.b < 0.5)
                                              src2.b = (src1.b * src2.b) * 2.0;
                                          else
                                              src2.b = (src1.b + src2.b) * 2.0 -
                                                       (src1.b * src2.b) * 2.0 - 1.0;
                                      ...
                                      void main(void) {
                                          ...
                                          bd = bd * bd / 1024.0;
                                          bd = 536870912.0 / bd;
                                          float alpha = 1.0 + lens_amount * (bd - 32768.0) / 256.0 /
                                                              32768.0;
...
void CustomFilter_0::render2Texture(ImageHandlerInterface *handler, GLuint srcTexture,
