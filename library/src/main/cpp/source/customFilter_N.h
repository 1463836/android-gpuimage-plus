...
class CustomFilter_1 : public CGE::ImageFilterInterface {
public:
...
class CustomFilter_3 : public CGE::ImageFilterInterface {
public:
...
class CustomFilter_4 : public CGE::ImageFilterInterface {
public:
