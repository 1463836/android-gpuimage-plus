...
#include "Mat.h"
#include "../cge/common/CommonDefine.h"

namespace CGE {
    //辅助类， 提供场景漫游公共方法以及参数
    class SceneInterfaceHelper {
    protected:
        SceneInterfaceHelper() : m_eye(0.0f, 0.0f), m_lookDir(0.0f, 1000.0f), m_eyeZ(0.0f),
                                 m_lookZ(0.0f), m_dirLen(1000.0f), m_fovyRad(M_PI / 4.0f),
                                 m_zNear(1.0f), m_zFar(1e5f), m_upDirRot(0.0f) {}
    ...
    public:
        ...
        inline void updateView() {
            ...
            m_modelViewMatrix = Mat4::makeLookAt(m_eye[0], m_eye[1], m_eyeZ, center[0], center[1],
                                                 m_eyeZ + m_lookZ, upDir[0], upDir[1], upDir[2]);
        }
    ...
    public:
        ...
        inline void updateView() {
            ...
            m_modelViewMatrix = Mat4::makeLookAt(m_eye[0], m_eye[1], m_eyeZ, center[0],
                                                 m_eye[1] + m_lookZ, center[1], upDir[0], upDir[1],
                                                 upDir[2]);
        }
