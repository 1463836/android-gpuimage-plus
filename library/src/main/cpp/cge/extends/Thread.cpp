...
namespace CGE {
    ...
    CGEThreadPreemptive::CGEThreadPreemptive() : m_thread(nullptr), m_taskRestart(false),
                                                 m_threadOver(false), m_runningStatus(false) {
    ...
    CGEThreadPool::Worker::Worker(CGEThreadPool &pool) : m_thread(nullptr), m_pool(pool),
                                                         m_runningStatus(false),
                                                         m_shouldLeave(false) {
