...
namespace CGE {
    ...
    bool TextureDrawer::initWithShaderString(CGEConstString vsh, CGEConstString fsh) {
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(CGEGlobalConfig::sVertexDataCommon),
                     CGEGlobalConfig::sVertexDataCommon, GL_STATIC_DRAW);
...
//        loge("------------------------------------------");
    ...
    void TextureDrawer4ExtOES::drawTexture(GLuint externalTexture) {
        glActiveTexture(GL_TEXTURE0);
